...
class PaymentServiceImplTest {
    ...
    void setUp() {
        ...
        product.setProductName("Sampo Cap Kina");
        product.setProductQuantity(1);
        products.add(product);

        orders = new ArrayList<>();

        Order order = new Order("13652556-012a-4c07-b546-54eb1396d79b", products, 1827070000L, "Lina Sudrajat");
        orders.add(order);
        ...
        Map<String, String> paymentData2 = Map.of("bankName", "EshopBank", "referenceCode", "9876543210");
        Payment payment2 = new Payment("13652556-012a-4c07-b546-54eb1396d79b", "BANK_TRANSFER", paymentData2);
    ...
    void testSetStatusRejected() {
        ...
        Payment result = paymentService.setStatus(payment, PaymentStatus.FAILED.getValue());
        verify(orderRepository, times(1)).save(order);
        verify(paymentRepository, times(1)).save(payment);
